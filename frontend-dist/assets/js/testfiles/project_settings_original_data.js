// Original project settings data (1 filament) - PASTE YOUR DATA HERE
// This should be the actual original data before any modifications

export const project_settings_original = {
